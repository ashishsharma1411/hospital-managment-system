...
con=sqltor.connect(host="localhost",user="root",password="Ashish222ku@")
cur=con.cursor()
...
def ser_avail():
    ...
    l5=Label(root5,text='To avail any of these please contact on our no.:- 8630877158, 8429169872')
    l5.place(x=20,y=240)
